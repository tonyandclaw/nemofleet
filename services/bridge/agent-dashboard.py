...
def do_sys(do, sb="", tail="200", provider="", model="", chan=""):
...
class H(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if p == "/api/sys":   # on-demand;admin:doctor / logs / stale / gsettings / recover / gwhealth / infset
            ...
            try:
                return self._send(200, json.dumps(do_sys(do, sb, tail, provider, model, chan), ensure_ascii=False), "application/json; charset=utf-8")
            except Exception as e:
